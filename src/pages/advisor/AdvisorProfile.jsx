// File: src/pages/advisor/AdvisorProfile.jsx
// Trang hồ sơ cố vấn dịch vụ tuân thủ APEX Modern UI
...
const AdvisorProfile = () => {
  ...
  const summaryCards = useMemo(() => {
    ...
    if (stats.todayAppointments !== undefined && stats.todayAppointments !== null) {
      cards.push({
    ...
    if (stats.totalCustomers !== undefined && stats.totalCustomers !== null) {
      cards.push({
        label: 'Khách hàng',
    ...
    if (stats.pendingOrders !== undefined && stats.pendingOrders !== null) {
      cards.push({
        label: 'Đơn chờ xử lý',
    ...
    if (stats.satisfactionRate !== undefined && stats.satisfactionRate !== null) {
      cards.push({
        label: 'Mức hài lòng',
  ...
  const responsibilityItems = [
    'Tiếp nhận và tư vấn khách hàng về dịch vụ bảo dưỡng',
    'Quản lý lịch hẹn và phân công công việc cho kỹ thuật viên',
    'Theo dõi tiến độ sửa chữa và cập nhật cho khách hàng',
    'Xử lý khiếu nại và giải đáp thắc mắc của khách hàng',
    'Báo giá dịch vụ và hỗ trợ thanh toán'
  ];
  ...
  const supportActions = [
    {
      ...
      note: 'Xem và xử lý lịch hẹn',
      variant: 'primary',
      disabled: false,
      route: ROUTES.ADVISOR.APPOINTMENTS
    },
    {
      icon: <FiBriefcase />,
      title: 'Quản lý đơn hàng',
      note: 'Theo dõi đơn dịch vụ',
      variant: 'ghost',
      disabled: false,
      route: ROUTES.ADVISOR.ORDERS
    },
    {
      icon: <FiMessageSquare />,
      title: 'Tin nhắn',
      note: 'Chat với khách hàng',
      variant: 'outline',
      disabled: false,
      route: ROUTES.ADVISOR.CHAT
    }
  ];

  const trustCard = useMemo(
    () => summaryCards.find((card) => card.label === 'Mức hài lòng'),
    [summaryCards]
  );
  ...
  return (
    <AdvisorLayout>
      <section className="advisor-profile-page">
            ...
            <div className="hero-main">
              <div className="hero-header">
                ...
                <div className="hero-info">
                  <p className="hero-pretitle">Hồ sơ cố vấn dịch vụ</p>
              ...
              <article className="glass-card form-card" ref={formSectionRef}>
                <div className="card-header">
                  <div>
                    ...
                    <p className="card-subtitle">Cập nhật thông tin liên hệ để khách hàng dễ dàng liên lạc.</p>
                  </div>
                </div>
                  ...
                  <div className="form-grid">
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        value={formData.email}
                        onChange={handleInputChange}
                        placeholder="advisor@apex-ev.com"
                      />
